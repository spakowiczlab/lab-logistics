---
title: "pelotonia-URF_training-table"
...
```{r}
x <- readxl::read_xlsx(file.path(paths$box.personnel,
                                 "mentee-list.xlsx"),
                       na = "NA")
```

The goal of this document is to create a training experince table for a Pelotonia Undergraduate Research Fellowship application. It should look like this:
